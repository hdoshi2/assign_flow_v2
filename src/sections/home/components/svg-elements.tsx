...
export function FloatLine({ sx, vertical, ...other }: BoxProps & { vertical?: boolean }) {
  return (
    <Box
      component="svg"
      sx={{
    ...
    >
      {vertical ? (
        <m.line
          ...
          y1="0"
          y2="100%"
          variants={{ initial: { y2: '0%' }, animate: { y2: '100%', transition } }}
        />
      ) : (
        <m.line
          x1="0"
          ...
          y1="0.5"
          y2="0.5"
          variants={{ initial: { x2: '0%' }, animate: { x2: '100%', transition } }}
        />
      )}
    </Box>
  );
...
export function FloatPlusIcon({ sx, ...other }: BoxProps) {
  return (
    <Box
      ...
      sx={{ ...baseStyles, width: 16, height: 16, ...sx }}
      {...other}
    >
...
export function FloatTriangleLeftIcon({ sx, ...other }: BoxProps) {
  return (
    <Box
      ...
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
      sx={{ ...baseStyles, width: 10, height: 20, ...sx }}
      {...other}
    >
...
export function FloatTriangleDownIcon({ sx, ...other }: BoxProps) {
  return (
    <Box
      ...
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
      sx={{ ...baseStyles, width: 20, height: 10, ...sx }}
      {...other}
    >
  ...
  return (
    ...
    >
      <defs>
        ...
        <clipPath id="clip0_3879_191598">
          <path fill="#fff" d="M0 0H560V560H0z" />
        </clipPath>
      </defs>

      <g clipPath="url(#clip0_3879_191598)">
        <mask
          id="mask0_3879_191598"
        ...
        >
          <path fill="url(#paint0_radial_3879_191598)" d="M0 0H560V560H0z" />
        </mask>

        <g stroke="currentColor" strokeDasharray={3} mask="url(#mask0_3879_191598)" opacity={0.4}>
