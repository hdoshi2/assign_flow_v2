...
import { fDate, InputDateValue } from 'src/utils/format-time';
    ...
    <Box
      sx={{
        ...theme.mixins.bgGradient(
          `0deg, ${alpha(theme.palette.grey[900], 0.9)}, ${alpha(theme.palette.grey[900], 0.9)}`,
...
function TestimonialCard({ testimonial, sx, ...other }: TestimonialCardProps) {
  ...
  return (
    <Stack
      spacing={3}
      sx={{
        ...theme.mixins.bgBlur(alpha(theme.palette.common.white, 0.08)),
        p: 3,
        borderRadius: 2,
        color: 'common.white',
        ...sx,
