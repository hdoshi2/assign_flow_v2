      ...
      >
        <NavSectionVertical
          ...
          slotProps={{
            ...
            subheader: {
              ...(config.hiddenSubheader && { display: 'none' }),
            },
          }}
        />
...
function ControlsPanel({ config, onChangeConfig, canReset, onReset }: ControlsPanelProps) {
  return (
    <Stack
      spacing={3}
      sx={{ p: 3, borderRadius: 2, bgcolor: 'background.neutral', position: 'relative' }}
    >
      ...
      {canReset && (
        <IconButton onClick={onReset} sx={{ position: 'absolute', top: 16, right: 16, zIndex: 9 }}>
