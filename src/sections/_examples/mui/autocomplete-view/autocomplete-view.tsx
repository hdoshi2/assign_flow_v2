...
import CountrySelect, { displayValueByCountryCode } from 'src/components/country-select';
        ...
        <ComponentBlock title="Country Select" sx={{ gap: 5 }}>
          <Stack direction="row" spacing={1.5} sx={{ width: 1 }}>
            <CountrySelect
              ...
              fullWidth
              value={singleLabel}
              onChange={(event, newValue) => setSingleLabel(newValue as string)}
          ...
          <Stack direction="row" spacing={1.5} sx={{ width: 1 }}>
            <CountrySelect
              ...
              getOptionLabel={(option) => displayValueByCountryCode(option)}
            />
            <Stack
              sx={{
                px: 1,
