...
export default function AccountDrawer() {
  ...
  }, [handleCloseDrawer, logout, router]);
            ...
            <Tooltip title="Add account">
              <IconButton
                sx={{
                  ...
                  border: (theme) => `dashed 1px ${alpha(theme.palette.grey[500], 0.32)}`,
                }}
              >
    ...
    <Stack
      sx={{
        ...theme.mixins.bgGradient(
          `135deg, ${alpha('#F7BB95', 0.92)}, ${alpha('#5B2FF3', 0.92)}`,
          '/assets/background/overlay-7.jpg'
        ),
        px: 3,
        py: 4,
        borderRadius: 2,
    ...
    >
      <Box
        sx={{
          ...
          borderRadius: 2,
          position: 'absolute',
          border: `solid 3px ${alpha(theme.palette.common.white, 0.16)}`,
        }}
      />
      ...
      <Box
        ...
        alt="Small Rocket"
        src="/assets/illustrations/illustration-rocket-small.png"
        sx={{ width: 112, height: 112, position: 'absolute', right: 0 }}
      />
      ...
      <Stack alignItems="flex-start" sx={{ position: 'relative' }}>
        ...
        <Box
          component="span"
          sx={{ mt: 0.5, mb: 2, typography: 'subtitle2', color: 'common.white' }}
        >
