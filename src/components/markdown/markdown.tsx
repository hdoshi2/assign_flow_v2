...
import { isMarkdown, htmlToMarkdown } from './html-to-markdown';
import { StyledRoot } from './styles';
import { markdownClasses } from './classes';

// ----------------------------------------------------------------------

export default function Markdown({ children, sx, ...other }: MarkdownProps) {
...
type ComponentTag = { [key: string]: any };
...
const components = {
  ...
  a: ({ href, children, node, ...other }: ComponentTag) => {
    const linkProps = href.includes('http')
