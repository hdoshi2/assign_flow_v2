...
import { alpha, useTheme, CSSObject } from '@mui/material/styles';
import ButtonBase, { buttonBaseClasses } from '@mui/material/ButtonBase';

import { carouselClasses } from '../classes';
import { CarouselArrowButtonProps, CarouselArrowButtonsProps } from '../types';
...
export function CarouselArrowFloatButtons({
  ...
  const baseStyles = {
    ...
    color: lightMode ? 'common.white' : 'grey.800',
    '&:hover': {
      opacity: 0.8,
    },
  } as CSSObject;
